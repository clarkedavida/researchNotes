\chapter{LGT: Computer Simulations}\label{ch:MCMC}
...
algorithm that fixes gauge configurations to the Coulomb or Lorentz gauges.

\begin{proposition}{}{ORgf}
A gauge satisfying $\partial_\mu A_\mu=0$ is achieved by extremizing
$$
...
will vanish. Exchanging our dummy group summation indices, we find 
\end{proof}
\end{proposition}
