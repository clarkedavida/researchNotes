...
But these flavors of neutrinos are not produced in the sun; therefore SNO also
...
\begin{equation}
  ...
  \end{aligned}
\end{equation}
Assuming the neutrino flavor does not change on its journey to the detector,
...
either case, it is clear that $|\Delta m_{31}^2|\approx|\Delta m_{32}^2|$.
...
with a particular particle but does not interfere with light itself.
...
physicists, but there is still more we need to learn. For example we do not yet
