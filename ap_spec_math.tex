...
of analytic or differentiable.} \index{function!regular}
function $f(x,y,z)$
...
\end{equation}
As expected, these formulas agree with \equatref{eq:3ds}
...
\end{proposition}
  ...
  The map of \propref{prp:orthog} is called the {\it orthogonal
  ...
  \index{transformation!positive definite}
  ...
  {\it positive definite} if its eigenvalues are all positive, and
  {\it positive semidefinite} if the eigenvalues are all nonnegative. 
