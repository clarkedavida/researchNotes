...
\begin{equation}
\partial_\omega M^{-1} =-M^{-1}\left(\partial_\omega M\right)M^{-1}
\end{equation}
the fermion force is generally writeable as
\begin{equation}
f_{\rm ferm}=
...
\end{equation}
This exposes that the inverse of $D^\dagger D$ must be computed
