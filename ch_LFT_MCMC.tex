...
Here and the following two subsections,
...
\subsection{Update: Molecular dynamics}\index{molecular dynamics}
...
This approach is completely deterministic, and hence does not
...
Metropolis step. To fulfill detailed balance, we need to ensure
that our integration scheme
\begin{enumerate}
  \item preserves the integration measure $\DD\phi\DD P$; and
  \item is reversible.
\end{enumerate}
A commonly used scheme that is reversible is known as the
...
You can find an elementary proof of reversibility under this
scheme in Ref.~\cite{gattringer_quantum_2010}.
