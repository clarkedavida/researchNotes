...
\begin{enumerate}
  \item {\it ergodicity}\footnote{Sometimes authors call this
        ...
        it is important that $n$ is not too large, otherwise some configurations
...
often referred to as the {\it Kennedy-Pendleton}\index{heat bath!Kennedy-Pendleton} algorithm, is explained in an elementary way 
...
operator, $\tr X$. This can be applied to correlators, but it is also useful for
