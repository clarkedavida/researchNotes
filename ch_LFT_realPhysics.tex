...
is another possibility. One can reweight in arbitrary parameters.
We showcase the idea by doing reweighting in $\beta$ for
pure $\SU(N)$ lattice gauge theory. Consider
