...
for an observable $O$ calculated on $N_f=2+1$ HISQ configurations:
...
with our other useful formulas, one
...
\end{aligned}\end{equation}
where the prime here indicates a derivative w.r.t. $\muh_f$.
