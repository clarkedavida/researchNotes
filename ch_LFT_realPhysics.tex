...
\propref{prop:dO} reduces to eq.~(A3)
...
In this section, we follow the introduction of Ref.~\cite{He:2022kbc}, which has
...
lattice~\cite{borsanyi_qcd_2010,bazavov_equation_2014}.
It has also been calculated using PNJL and NJL 
models~\cite{ghosh_susceptibilities_2006,marty_transport_2013,deb_estimating_2016,motta_isentropic_2020}
