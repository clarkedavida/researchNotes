...
for $g$, and we see it's nonzero at $z_0$ due to the leading term.
\end{proof}
\end{proposition}
...
then it's fully nonzero in some deleted neighborhood.
...
Since it's identically zero in $N$, its Taylor coefficients must be zero there,
