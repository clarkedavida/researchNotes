...
has semi-major and semi-minor directions parallel to the
...
assuming the Gaussian random variables, the probability
that the true mean pair $\hat{x}_1$, $\hat{x}_2$ lies
in the confidence ellipse $E$ is
\begin{equation}\begin{aligned}
\pr{\hat{x}_1,\hat{x}_2\in E} & =\frac{1}{\sqrt{2 \pi \lambda_1}} \frac{1}{\sqrt{2 \pi \lambda_2}}
\int_{\text {ellipse }} \dd{x_1}\dd{x_2} \exp \left(-\frac{x_1^2}{2 \lambda_1}\right) \exp \left(-\frac{x_2^2}{2 \lambda_2}\right) \\
...
for instance we may know they have to be positive. In the cases where we don't,
we can simplify
\begin{equation}
