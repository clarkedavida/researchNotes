...
\section{Grassmann numbers}\index{algebra!Grassman}
...
\section{Staggered fermions}\index{fermion!staggered}\index{staggered!fermions}
...
\secref{sec:improvedActions}.} such
...
\subsection{Fat links}\index{link!fat}
