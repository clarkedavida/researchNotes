...
We start by considering systems with $h=0$. 
We note that, near a second-order critical point, the correlation
...
\end{equation}
To keep our scaling laws consistent, we demand that $g$ has the limiting behavior
\begin{equation}
