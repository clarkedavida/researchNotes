...
\begin{equation}
\Tc=\frac{2 J}{k_B \ln (1+\sqrt{2})}\approx(2.269185) \frac{J}{k_B}.
\end{equation}
...
field theory in \chref{ch:MCMC}.}. For the 3-$d$ Ising model,
one finds~\cite{alves_ising-model_1990}
\begin{equation}
\Tc=4.51325(82).
\end{equation}
...
{\it Potts model}\index{Potts model}, originally studied by 
...
Estimates of the critical temperature for some choices
of $d$ and $q$ are collected in \tabref{tab:pottsTc}. 

\begin{table}
\centering
\caption{Some critical temperatures for the Potts model.}
\begin{tabularx}{\linewidth}{LR}
\hline\hline
$d=3$, $q=3$ & $d=2$, $q=10$ \\
\hline
3.632908(64)~\cite{alves_potts_1991} & 0.70123178~\cite{alves_potts_1991}\\
...
the $q$-state {\it clock model}\index{clock model} or 
{\it vector Potts model}\index{Potts model!vector} with Hamiltonian 
