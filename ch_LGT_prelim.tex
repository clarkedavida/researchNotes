...
first to show that the Polyakov loop renormalizes as~\cite{polyakov_gauge_1980}
\begin{equation}\label{eq:renploop}
  P\ren=Z(\beta)^{N_\tau}P,
\end{equation}
where $Z(\beta)$ is the renormalization of the gauge field, i.e. of
each link. From \equatref{eq:Fav} it is then clear that $F_{q\bar{q}}$ requires an
...
require a separate 
renormalization~\cite{polyakov_gauge_1980,korchemsky_renormalization_1987}.
This includes, among other things, the Polyakov loop susceptibility.
