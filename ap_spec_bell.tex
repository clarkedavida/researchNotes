...
it is fun to think about philosophically in the context of free will.

Let us recall what happens when you make a measurement in a quantum system.
...
\cite{einstein_can_1935} published the\index{EPR paradox} {\it EPR paradox},
...
be examined more carefully in \secref{sec:interpretingBell}.}. 
On the other
...
some kind of missing information, or\index{hidden variable} {\it hidden variable}, which
...
backwards light cones. See \secref{sec:interpretingBell}.}; this
assumption is sometimes called\index{independence} {\it independence}. With this modest
...
Let us now compute the average $P_{\vec{a},\vec{b}}$. We do not know 
...
\end{aligned}\end{equation}
since $A(\vec{b},\lambda)^2=1$. From \equatref{eq:bellindep} and
...
\end{equation}
Therefore\index{Bell's inequality}
...
the QM prediction \equatref{eq:bellQM}. For suppose $\vec{a}$, $\vec{b}$,
...
\equatref{eq:bellindep}. One could imagine\footnote{This is not necessarily
...
this are sometimes called\index{superdeterminism} {\it superdeterministic}.
...
One thing which is interesting about superdeterminism is, if it is true,
