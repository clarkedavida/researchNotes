...
parameters. Overfit models will label the training data
...
probability $p$. This {\it thinned network}\index{neural network!thinned}
...
the same scale relative to each other.
