...
of thermodynamics\index{thermodynamic} and statistical physics. In this chapter I try to
...
\section{The laws of thermodynamics}\index{thermodynamic!laws}
...
and {\it reversible}\index{reversible} if $Q=T\ddS$, where $T$ is the
...
\end{equation}
Reorganizing \equatref{eq:grand} yields the Gibbs-Duhem relation
