...
\end{equation}
The third-nearest-neighbor is constructed by three thin links going in the same
direction, which is called a {\it Naik link}\index{link!Naik}. The
nearest-neighbor interaction is
...
\begin{equation}
c_1=\frac{1}{8},~~~c_3=\frac{1}{16},~~~c_5={1}{64},~~~c_7=\frac{1}{384},
