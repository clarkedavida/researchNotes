...
Maxwell's equations as a starting point. Given that ambiguity and the fact
...
\index{kaon} and {\it lambda} ($\Lambda$)~\cite{hopper_evidence_1950}\index{lambda} 
...
illustrated in \figref{fig:eightfold}. Gell-Mann
...
\subsection{Weak sector}\index{interaction!weak}


In the mid 1950s, Lee and Yang~\cite{lee_question_1956} suggested possible
experimental tests to search for parity violation in weak interaction processes.
...
%   WEAK SECTOR
% - fermi formulates first beta-decay theory
% - feynman and gell-mann make fermi theory chiral
% - tree-level results agree with experiment, loop corrections infinite
% - massive particles <--> finite interaction range?
% - need massive gauge bosons, nambu applies ginzburg-landau SSB to
%   particle physics, implies existence of goldstone modes that
%   are not seen
% - brout englert higgs note that suitable choice of gauge eliminates
%   goldstone modes, adds mass term to gauge bosons, adds higgs boson.
% - was only for massive qed, generalized to non-abelian theories by kibble
% - glashow 1961 SU(2)xU(1)
% - weinberg and salam apply kibble results to glashow idea, show it
%   produces masses for electrons, muons, gauge bosons
% - theory predicted neutral weak currents, discovered in 73 by the
%   gargamelle experiment
% - veltman and t'hooft show theory is renormalizable
% - quark mixing in weak interactions (cabibbo 1963) explanation for
%   lifetimes of heavier hadrons, cabibbo-suppression
% - kobayashi maskawa predict third generation existence b/c quark mixing
%   with three generations minimal model allowing CP violation
% - third generation discovered, tau 75, bottom 77, top 95, tauneut 2000
%
%
