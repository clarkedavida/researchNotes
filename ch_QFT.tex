...
\end{equation}
The adjoint spinor allows us to write down the Lorentz scalar $\bar{\psi}\psi$ and
the Lorentz vector $\bar{\psi}\gamma^\mu\psi$. 
...
\end{equation}
We close with some derivable algebraic properties of the $\gamma$s:
