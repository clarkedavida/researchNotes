...
%TODO: principle least action i guess. also noether's theorem
Our starting point no longer distinguishes between space and time, as desired.
In this formulation, the Euler-Lagrange equations become
...
\begin{equation}
\Lagr\sim\partial_\mu\phi\partial^\mu\phi+m^2\phi^2.
\end{equation}
...
Gamma matrix identities in 4-$d$:
...
We follow a very nicely written and illustrated thesis~\cite{valois_thermal_2025}.
...
%\section{Magnetic fields in QCD}
%
%Strong magnetic fields manifest in the off-central HICs discussed above, and
%they are also present in neutron stars and the primordial universe. In the case
%of 
